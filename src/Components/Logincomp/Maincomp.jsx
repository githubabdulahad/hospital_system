...
import image from "../../assets/images/loginimages/loginimg.png";
import logo from "../../assets/images/loginimages/logo.svg";
import kingslogo from "../../assets/images/loginimages/kingslogo.png";
...
export default function Maincomp() {
  ...
  const handleSubmit = (e) => {
    ...
    else if (form.role === "pharmacist") navigate("/pharmacist/dashboard");
    else if (form.role === "accountant") navigate("/accountant/dashboard");
