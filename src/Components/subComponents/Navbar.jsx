...
import logo from "../../assets/images/kingsCollege.png";
        ...
        <div className="flex items-center max-w-7xl w-full  md:px-6 relative">
          ...
          <div className="flex items-center flex-1 rounded-full rounded-r-full shadow-sm border border-gray-200 bg-[#B1B9C233] py-2 pl-4 pr-12 relative">
            ...
            <nav className="hidden md:flex flex-1 justify-center items-center space-x-4 lg:space-x-6 text-[#1a2c48] font-semibold text-xs md:text-sm">
              <Link to="/about" className="hover:text-[#4C60AB]">
                ABOUT
              </Link>
              <Link to="/specialties" className="hover:text-[#4C60AB]">
                SPECIALTIES
              </Link>
              <Link to="/doctors" className="hover:text-[#4C60AB]">
                DOCTORS
              </Link>
              <Link to="/appointment" className="hover:text-[#4C60AB]">
                APPOINTMENT
              </Link>
              <Link to="/contact" className="hover:text-[#4C60AB]">
                CONTACT
              </Link>
              <Link to="/insurance" className="hover:text-[#4C60AB]">
                INSURANCE
              </Link>
              <Link to="/careers" className="hover:text-[#4C60AB]">
                CAREERS
              </Link>
            </nav>
            {/* Mobile Nav Links */}
            {mobileMenuOpen && (
              <nav className="absolute top-12 left-0 w-full bg-white border-t border-gray-200 flex flex-col items-center space-y-2 py-4 shadow-lg md:hidden z-50">
                <Link to="/about" className="hover:text-[#4C60AB] w-full text-center py-2" onClick={() => setMobileMenuOpen(false)}>
                  ABOUT
                </Link>
                <Link to="/specialties" className="hover:text-[#4C60AB] w-full text-center py-2" onClick={() => setMobileMenuOpen(false)}>
                  SPECIALTIES
                </Link>
                <Link to="/doctors" className="hover:text-[#4C60AB] w-full text-center py-2" onClick={() => setMobileMenuOpen(false)}>
                  DOCTORS
                </Link>
                <Link to="/appointment" className="hover:text-[#4C60AB] w-full text-center py-2" onClick={() => setMobileMenuOpen(false)}>
                  APPOINTMENT
                </Link>
                <Link to="/contact" className="hover:text-[#4C60AB] w-full text-center py-2" onClick={() => setMobileMenuOpen(false)}>
                  CONTACT
                </Link>
                <Link to="/insurance" className="hover:text-[#4C60AB] w-full text-center py-2" onClick={() => setMobileMenuOpen(false)}>
                  INSURANCE
                </Link>
                <Link to="/careers" className="hover:text-[#4C60AB] w-full text-center py-2" onClick={() => setMobileMenuOpen(false)}>
                  CAREERS
                </Link>
              </nav>
            )}
