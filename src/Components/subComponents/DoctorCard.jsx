  ...
  return (
    ...
    >
      <img
        ...
        draggable="false"
      />
      <div className="absolute left-1/2 transform -translate-x-1/2 bottom-18 translate-y-1/2 bg-[#0B2443] w-11/12 rounded-xl px-6 py-5 flex flex-col items-center text-white shadow-lg">
