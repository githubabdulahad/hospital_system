...
import slide1 from "../../assets/images/Sliderimage.png";
import slide2 from "../../assets/images/Sliderimage2.jpg";
...
const SliderComp = () => {
	...
	const getObjectPosition = () => {
		if (slides[current] === slide1) return "center 0%";
		if (slides[current] === slide2) return "center 0%";
		if (slides[current] === slide3) return "center 30%";
		return "center";
	};
