...
const EditPayrollModal = ({ payroll, onClose, onSubmit }) => {
        ...
        <div className="sticky top-0 bg-white/90 backdrop-blur-md border-b border-gray-200 px-8 py-6 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-[#0B2443]">Edit Payroll</h2>
