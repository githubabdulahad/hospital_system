...
import image1 from '../../assets/images/contactimg/contacthistory1.png'
import image2 from '../../assets/images/contactimg/contacthistory2.png'
import image3 from '../../assets/images/contactimg/contacthistory3.png'
import image4 from '../../assets/images/contactimg/contacthistory4.png'
import image5 from '../../assets/images/contactimg/contacthistory5.png'
        ...
        <div className="relative flex justify-around items-end pb-20">
          ...
          <div className="flex flex-col items-center text-center max-w-xs mx-4 relative z-10 mb-8 md:mb-0">
            <div className="relative mb-6">
              ...
              <img src={image1} alt="1980 Medical School" className="w-full max-w-[200px] h-auto border border-gray-200 shadow-md" />
              {/* Dot */}
  <img src={image5} alt="" className='w-[248px] -ml-6 -mt-3'/>
            </div>
          ...
          <div className="flex flex-col items-center text-center max-w-xs mx-4 relative z-10 mb-8 md:mb-0">
            <div className="relative mb-6">
              {/* Replace with your actual image path */}
              <img src={image2} alt="1990 Medical School" className="w-full max-w-[200px] h-auto border border-gray-200 shadow-md" />
              {/* Dot */}
  <img src={image5} alt="" className='w-[248px] -ml-6 -mt-3'/>
            </div>
          ...
          <div className="flex flex-col items-center text-center max-w-xs mx-4 relative z-10 mb-8 md:mb-0">
            <div className="relative mb-6">
              {/* Replace with your actual image path */}
              <img src={image3} alt="2000 Medical School" className="w-full max-w-[200px] h-auto border border-gray-200 shadow-md" />
              {/* Dot */}
  <img src={image5} alt="" className='w-[248px] -ml-6 -mt-3'/>
            </div>
          ...
          <div className="flex flex-col items-center text-center max-w-xs mx-4 relative z-10 mb-8 md:mb-0">
            <div className="relative mb-6">
              {/* Replace with your actual image path */}
              <img src={image4} alt="2001 Medical School" className="w-full max-w-[200px] h-auto border border-gray-200 shadow-md" />
              {/* Dot */}
  <img src={image5} alt="" className='w-[248px] -ml-6 -mt-3'/>
            </div>
