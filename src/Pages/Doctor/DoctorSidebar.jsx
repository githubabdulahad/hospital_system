...
const appointmentDropdownItems = [
  ...
  { label: 'Requested Appointments', to: 'requested-appointments' },
];
  ...
  return (
    <aside className="w-70 bg-[#232946] text-white flex flex-col shadow-lg sticky top-0 overflow-y-auto" style={{ fontFamily: "'Gill Sans MT', 'Gill Sans', 'GillSans', 'Arial', 'sans-serif'", height: 'calc(100vh - 120px)' }}>
      <div className="flex flex-col items-center py-8 border-b border-gray-700">
        ...
        <div className="text-lg font-semibold">Welcome, Dr. Micheal Pewd</div>
      </div>
      <nav className="flex-1 py-6 px-2 space-y-1">
        ...
        <SidebarDropdown label="Appointment" icon={
