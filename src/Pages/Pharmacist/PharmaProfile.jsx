      ...
      <div className="bg-white/80 backdrop-blur-sm border-b border-gray-200 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Link to='/pharmacist/manage-medicine' className="px-4 py-2 bg-[#198172] text-white hover:bg-[#0B2443] rounded-lg transition-colors font-medium">
              Manage Medicines
            </Link>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 p-6 text-center">
            ...
            <h3 className="text-2xl font-bold text-[#0B2443] mb-1">{profile.totalMedicines}</h3>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 p-6 text-center">
            ...
            <h3 className="text-2xl font-bold text-[#0B2443] mb-1">${profile.totalSales.toLocaleString()}</h3>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 p-6 text-center">
            ...
            <h3 className="text-2xl font-bold text-[#0B2443] mb-1">{profile.medicineCategories}</h3>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 p-6 text-center">
            ...
            <h3 className="text-2xl font-bold text-[#0B2443] mb-1">${profile.monthlySales.toLocaleString()}</h3>
