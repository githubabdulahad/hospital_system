  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#C0E6DA]/30 via-white to-[#198172]/10 p-6" style={{ fontFamily: "'Gill Sans MT', 'Gill Sans', 'GillSans', 'Arial', 'sans-serif'" }}>
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <CommonAddButton label="Add New Department" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 text-center">
          ...
          <h3 className="text-2xl font-bold text-[#0B2443] mb-1">{departments.length}</h3>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 text-center">
          ...
          <h3 className="text-2xl font-bold text-[#0B2443] mb-1">{departments.reduce((sum, dept) => sum + dept.doctorCount, 0)}</h3>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 text-center">
          ...
          <h3 className="text-2xl font-bold text-[#0B2443] mb-1">{departments.reduce((sum, dept) => sum + dept.facilities.length, 0)}</h3>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 text-center">
          ...
          <h3 className="text-2xl font-bold text-[#0B2443] mb-1">24/7</h3>
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                ...
                <div className="flex items-center space-x-2">
                  <button className="p-2 text-[#198172] hover:bg-[#C0E6DA]/20 rounded-lg transition-colors" title="Edit Department">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                    </svg>
                  </button>
                  
                  <button className="p-2 text-red-500 hover:bg-red-50 rounded-lg transition-colors" title="Delete Department">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex justify-between items-center mt-8 pt-6 border-t border-gray-200">
        ...
        <div className="flex items-center space-x-2">
          <button className="px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition-colors" disabled>
            Previous
          </button>
          <span className="px-3 py-2 bg-[#198172] text-white rounded-lg text-sm font-medium">1</span>
          <button className="px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition-colors" disabled>
            Next
          </button>
        </div>
