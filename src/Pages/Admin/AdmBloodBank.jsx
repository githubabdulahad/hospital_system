...
const bloodBankData = [
  { group: 'A+', status: '10 bags' },
  { group: 'A-', status: '3 bags' },
  { group: 'AB+', status: '0 bags' },
  { group: 'AB-', status: '1 bags' },
  { group: 'B+', status: '2 bags' },
  { group: 'B-', status: '0 bags' },
  { group: 'O+', status: '3 bags' },
  { group: 'O-', status: '0 bags' },
];
  ...
  return (
    <div className="p-6" style={{ fontFamily: "'Gill Sans MT', 'Gill Sans', 'GillSans', 'Arial', 'sans-serif'" }}>
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-3xl font-semibold text-gray-500">Blood Bank</h2>
      </div>
      <CommonTable
      ...
      <div className="flex justify-between items-center mt-4 text-gray-500 text-xs">
        <span>Showing 1 to {bloodBankData.length} of {bloodBankData.length} entries</span>
