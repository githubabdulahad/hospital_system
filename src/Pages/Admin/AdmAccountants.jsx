  ...
  return (
    ...
    >
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-3xl font-semibold text-gray-500">Accountants</h2>
      </div>
      <div className="flex justify-between items-center mb-4">
        <div></div>
        <CommonAddButton label="Add Accountant" />
      </div>
      <CommonTable
        columns={[
        ...
        data={filteredAccountants.map((acc) => ({ ...acc, profile: true }))}
        actions={[
          {
            label: (
              <button
      ...
      <div className="flex justify-between items-center mt-4 text-gray-500 text-xs">
        <span>
          Showing 1 to {filteredAccountants.length} of{" "}
          {filteredAccountants.length} entries
        </span>
