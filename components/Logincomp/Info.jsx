    ...
    <div >
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center text-gray-400 text-xs md:text-sm px-2 py-1">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center flex-wrap gap-y-1 w-full md:w-auto">
          {/* location icon */}
          <div className="flex items-center ml-0 sm:ml-3 mt-1 sm:mt-0">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 text-gray-400 inline-block flex-shrink-0"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
            ...
            <p className="ml-1 break-words sm:appearance-none ">
          ...
          <div className="flex items-center ml-0 sm:ml-4 mt-1 sm:mt-0">
            ...
            <p className="ml-1 break-words">Monday - Sunday 8.00 - 20.00.</p>
          </div>
          {/* telephone icon */}
          <div className="flex items-center ml-0 sm:ml-4 mt-1 sm:mt-0">
            <svg
            ...
            <p className="ml-1 break-words">+971 1 800 7777</p>
          </div>
        </div>
        {/* Social Media Icons: stack vertically on small screens, horizontally on md+ */}
        <div className="flex flex-col md:flex-row items-center gap-4 sm:gap-6 mt-4 md:mt-0 md:mr-4 justify-center md:justify-end w-full md:w-auto">
          {/* Twitter */}
          <a
