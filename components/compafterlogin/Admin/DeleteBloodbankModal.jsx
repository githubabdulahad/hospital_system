...
export default function DeleteBloodbankModal({confirmDelete, cancelDelete, bloodToDelete}) {
    return(
          ...
          <div className="bg-white rounded-lg max-w-md w-full">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Are you sure you want to delete blood unit <strong>{bloodToDelete.bloodId}</strong> ({bloodToDelete.bloodType})? 
