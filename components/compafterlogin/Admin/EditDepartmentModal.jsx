...
const EditDepartmentModal = ({ isOpen, onClose, onEdit, department }) => {
  ...
  useEffect(() => {
    if (department && isOpen) {
      setFormData({
        ...
        doctorCount: department.doctorCount?.toString() || '',
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      const updatedDepartment = {
        ...
        image: formData.image || department.image,
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white pl-4 pt-1 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto" style={{ fontFamily: "'Gill Sans MT', 'Gill Sans', 'GillSans', 'Arial', 'sans-serif'" }}>
        {/* Modal Header */}
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#0B2443]">Edit Department</h2>
