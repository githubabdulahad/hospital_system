    ...
    >
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center">
          <span className="text-2xl mr-2 hidden md:block">
            <svg
          ...
          {/* Desktop title */}
          <h2 className="text-3xl font-semibold text-[#0B2443] text-nowrap hidden md:block">Doctor Profile</h2>
        </div>
      ...
      {/* Mobile: icon and title in one row, button below */}
      <div className="md:hidden flex flex-col items-center mb-4">
        <div className="flex items-center mb-2">
          ...
          <h2 className="text-2xl font-semibold text-[#0B2443]">Doctor Profile</h2>
        </div>
        {isEditing ? (
          ...
          <button
            onClick={() => setIsEditing(true)}
            className="px-4 py-2 bg-[#0B2443] text-white rounded-md hover:bg-blue-900 flex items-center mt-2"
          >
            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              <path d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
            </svg>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex flex-col items-center">
              ...
              <div className="w-full space-y-3 text-center">
                ...
                <div className="flex items-center text-sm justify-center text-gray-600">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
