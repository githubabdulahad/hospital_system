...
import { FaUserMd, FaPlus, FaEdit, FaTrash,FaEnvelope, FaPhone, FaBuilding } from 'react-icons/fa';
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage hospital doctors and medical staff</p>
          </div>
        </div>
        <button
