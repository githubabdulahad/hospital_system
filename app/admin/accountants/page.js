...
import { FaCalculator, FaPlus, FaEdit, FaTrash, FaTint, FaEnvelope, FaPhone, FaVenusMars, FaUserCircle, FaDollarSign, FaIdCard, FaCalendar, FaUser, FaBuilding, FaUserGraduate } from 'react-icons/fa';
    ...
    <div className="p-6" style={{ fontFamily: "'Gill Sans MT', 'Gill Sans', 'GillSans', 'Arial', 'sans-serif'" }}>
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
        ...
        <button
          ...
          className="bg-[#0B2443]  hover:bg-blue-900 text-white px-6 py-3 rounded-lg font-medium w-1/2 md:w-auto flex items-center gap-2 transition-colors shadow-lg"
        >
